...
import { IChange, IRenamed, TColumn } from './types'
import { getTableAnalyzation } from './parse'

export const getChanges = (oldTableString: TColumn, newTableString: TColumn) => {
    const fullOld = getTableAnalyzation(oldTableString)
    const fullNew = getTableAnalyzation(newTableString)
