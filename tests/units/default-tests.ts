...
import { chats, messages, posts, devices, users, spots, specificUsers, SpotModel, PostModel, PostList, ChatModel, MessageModel, UserSpecificModel, UserSpecificList } from './data'

export default async (FULL_TESTING: boolean) => {
